...
import net.xuset.triGame.game.entities.buildings.types.PointCollectorCreator;
...
final class CreationFuncs {
	static final BuildingInfo[] INFOS = new BuildingInfo[] {
		StrongWall.INFO,
		HeadQuarters.INFO,
		Barrier.INFO,
		SteelBarrier.INFO,
	...
	final ArrayList<BuildingCreator> creators = new ArrayList<BuildingCreator>();
	...
	BuildingCreator getCreator(BuildingInfo info) {
	...
	CreationFuncs(BuildingManager bm, ManagerController mc, ManagerService managers,
